...
class App extends React.Component {
    ...
    fetchBackendData = () => {
        axios.get('http://localhost:8180/resources/secure', { headers: { 'Authorization': ' Bearer ' + this.state.keycloak.token } })
    ...
    render() {
        ...
        <Header.Subheader>Simple protoype with React, Keycloak and MicroProfile</Header.Subheader>
        </Header>
